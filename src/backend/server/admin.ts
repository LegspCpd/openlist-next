...
const driverConfigs: Record<string, any> = {
    ...
    additional: [
      {
        ...
        default: "",
        required: true,
        help: "URL 树结构文本，每行缩进 2 空格表示一级。目录行以 : 结尾，文件行 [FileSize:][Modified:]Url",
      },
      {
        name: "private_key",
        type: "text",
        default: "",
        required: false,
        help: "123 网盘直链签名私钥（留空则直接透传原始 URL）",
      },
      {
        name: "uid",
        type: "number",
        default: "0",
        required: false,
        help: "123 网盘用户 ID（参与 auth_key 签名）",
      },
      {
        name: "valid_duration",
        type: "number",
  ...
  HalalCloud: {
    ...
    additional: [
      ...
      { name: "app_id", type: "string", default: "alist/10001", required: true },
      { name: "app_version", type: "string", default: "1.0.0", required: true },
      {
        name: "app_secret",
        type: "string",
